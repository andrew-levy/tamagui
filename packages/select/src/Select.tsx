...
import { NativeSelectIOS } from "./NativeSelectIOS";
...
const SelectValue = SelectValueFrame.styleable<SelectValueProps>(
  function SelectValue(
    ...
    const selectValueChildren = isEmptyValue
...
>((props: ScopedProps<SelectItemIndicatorProps>, forwardedRef) => {
  ...
  const context = useSelectItemParentContext(
    ITEM_INDICATOR_NAME,
    __scopeSelect
  );
...
export const Select = withStaticProperties(
  (props: ScopedProps<SelectProps>) => {
    ...
    if (props.native === "ios" && Platform.OS === "ios") {
      return <NativeSelectIOS {...props} />;
    }
